...
const serverlessConfiguration: AWS = {
  ...
  provider: {
    ...
    environment: {
      ...
      TOPIC_ARN_PE: "${ssm:/topic/${self:provider.stage}/SNSTopicPE}",
      TOPIC_ARN_CO: "${ssm:/topic/${self:provider.stage}/SNSTopicCO}",
      TOPIC_ARN_MX: "${ssm:/topic/${self:provider.stage}/SNSTopicMX}",
    },
    iam: {
